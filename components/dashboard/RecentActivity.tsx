...
function RecentActivity() {
    ...
    return (
        <div className="p-4 lg:p-6.25 bg-[rgba(15,23,43,0.5)] border border-[rgba(43,128,255,0.2)] rounded-2xl text-white">
            ...
            <h5 className="text-[16px] md:text-[18px] lg:text-[20px]">Recent Activity</h5>
...
{activities.map(a=>(
                ...
                <div className="flex flex-col gap-1">
                    <p className="text-[#FFFFFF] text-[12px] lg:text-[14px]">{a.text}</p>
                    <p className="text-[#7A8BA4] text-[10px] lg:text-[12px]">{a.timestamp}</p>
                </div>
