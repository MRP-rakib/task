...
function ProfileSetting() {
    return (
        <div>
            ...
            <form className='py-10 grid grid-cols-1 lg:grid-cols-2 gap-7.5 lg:gap-14'>
                <div className='flex flex-col gap-4 lg:gap-6'>
                    <div className='flex flex-col gap-2'>
                    <label className='text-[14px] text-white lg:text-[20px]' htmlFor="name">Full Name</label>
                    <Inputs value='Jane D.' />
                </div>
                <div className='flex flex-col gap-2'>
                    <label className='text-[14px] text-white lg:text-[20px]' htmlFor="name">Email</label>
                    <Inputs value='jane@gmail.com' />
                </div>
                </div>
                <div className='flex flex-col gap-4 lg:gap-6'>
                    <div className='flex flex-col gap-2'>
                    <label className='text-[14px] text-white lg:text-[20px]' htmlFor="name">Store Name</label>
                    <Inputs value='Ubreakfix Store' />
                </div>
                <div className='flex flex-col gap-2'>
                    <label className='text-[14px] text-white lg:text-[20px]' htmlFor="name">Store Address</label>
