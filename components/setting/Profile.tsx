...
function Profile() {
    return (
        <div>
            ...
            <div className='py-10'>
                 <table className=" text-[14px] md:text-[16px] lg:text-[20px] text-white font-medium border-collapse">
                        <tbody>
                            ...
                            <tr className="border-b border-[#192D71]">
                                <td className="py-4 pr-16 text-nowrap">Store Name:</td>
                                <td className="py-4 text-left">Ubreakfix Store</td>
                            </tr>
                            <tr className="border-b border-[#192D71]">
                                <td className="py-4 pr-16 text-nowrap">Store Address:</td>
